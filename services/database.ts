...
export const db = {
    ...
    addProgram: (program: Omit<Program, 'id'>) => addItem('programs', program),
    updateProgram: (program: Program) => updateItem('programs', program),
    deleteProgram: (id: string) => deleteItem('programs', id),
