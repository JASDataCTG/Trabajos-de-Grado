    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex justify-end space-x-3 pt-4">
                ...
                <button type="submit" className="bg-primary-600 text-white px-4 py-2 rounded-md hover:bg-primary-700">Guardar Docente</button>
            </div>
        </form>
    );
};
    ...
    return (
        <div className="space-y-6">
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {teachers.map(teacher => (
                             ...
                             {teachers.length === 0 && (
                                <tr>
                                    <td colSpan={4} className="text-center py-10 text-gray-500">No se encontraron docentes.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
            ...
            <ConfirmationDialog 
                ...
                message={`¿Estás seguro de que quieres eliminar a ${deletingTeacher?.name}? Esto también lo eliminará de cualquier proyecto. Esta acción no se puede deshacer.`}
            />
        </div>
    );
};